...
//        cookieId = ++cookieCounter;
    ...
    private void initDefaultStyle(Context context) {
        TypedArray typedArray = context.obtainStyledAttributes(R.styleable.Cookie);
        int titleColor = typedArray.getColor(R.styleable.Cookie_cookieTitleColor, Color.WHITE);
        int messageColor = typedArray.getColor(R.styleable.Cookie_cookieMessageColor, Color.WHITE);
        int actionColor = typedArray.getColor(R.styleable.Cookie_cookieActionColor, Color.WHITE);
        int backgroundColor = typedArray.getColor(R.styleable.Cookie_cookieBackgroundColor, ContextCompat.getColor(context, R.color.default_bg_color));
        typedArray.recycle();
